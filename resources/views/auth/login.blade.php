                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="email" maxlength="{{config('forms.email')}}" class="form-control" name="email" value="{{ old('email') }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="password" type="password" maxlength="{{config('forms.password')}}" class="form-control" name="password" required>
                        ...
                        <div class="form-group">
                            <div class="col-md-8 col-md-offset-4">
                                ...
                                <a class="btn btn-link" href="{{ route('password.request') }}">
                                    @lang('general.forgot_your_password')
                                </a>
                            </div>
                        </div>
                    </form>
