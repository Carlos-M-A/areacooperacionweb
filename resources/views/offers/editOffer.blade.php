                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('editOffer', ['id'=> $offer->id]) }}">
                        ...
                        <div id="description_div" class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="description" type="text" class="form-control" name="description" value="{{ old('description')?old('description') : $offer->description }}" autofocus>
                        ...
                        <div id="requeriments_div" class="form-group{{ $errors->has('requeriments') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="requeriments" type="text" class="form-control" name="requeriments" value="{{ old('requeriments')?old('requeriments') : $offer->requeriments }}" autofocus>
                        ...
                        <div id="workplan_div" class="form-group{{ $errors->has('workplan') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="workplan" type="text" class="form-control" name="workplan" value="{{ old('workplan')?old('workplan') : $offer->workplan }}" autofocus>
                        ...
                        <div id="schedule_div" class="form-group{{ $errors->has('schedule') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="schedule" type="text" class="form-control" name="schedule" value="{{ old('schedule')?old('schedule') : $offer->schedule }}" autofocus>
                        ...
                        <div id="totalHours_div" class="form-group{{ $errors->has('totalHours') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="totalHours" type="text" class="form-control" name="totalHours" value="{{ old('totalHours')?old('totalHours') : $offer->totalHours }}" autofocus>
                        ...
                        <div id="possibleStartDates_div" class="form-group{{ $errors->has('possibleStartDates') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="possibleStartDates" type="text" class="form-control" name="possibleStartDates" value="{{ old('possibleStartDates')?old('possibleStartDates') : $offer->possibleStartDates }}" autofocus>
                        ...
                        <div id="possibleEndDates_div" class="form-group{{ $errors->has('possibleEndDates') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="possibleEndDates" type="text" class="form-control" name="possibleEndDates" value="{{ old('possibleEndDates')?old('possibleEndDates') : $offer->possibleEndDates }}" autofocus>
                        ...
                        <div id="monetaryHelp_div" class="form-group{{ $errors->has('monetaryHelp') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="monetaryHelp" type="text" class="form-control" name="monetaryHelp" value="{{ old('monetaryHelp')?old('monetaryHelp') : $offer->monetaryHelp }}" autofocus>
