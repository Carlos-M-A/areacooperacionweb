                    ...
                    @foreach($users as $user)
                        ...
                        <div class="media">
                            <div class="media-left">
                                ...
                                <img src="{{url($user->urlAvatar)}}" class="media-object" style="width:60px;height:60px;">
                                @else
                                <img src="{{URL::asset('images/avatar.jpg')}}" class="media-object" style="width:60px;height:60px;">
                                @endif
